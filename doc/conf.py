...
htmlhelp_basename = 'IOTileAnalyticsdoc'
...
latex_documents = [
  (master_doc, 'IOTileAnalytics.tex', u'IOTile Analytics Documentation',
...
man_pages = [
    (master_doc, 'iotileanalytics', u'IOTile Analytics Documentation',
     [author], 1)
]
...
texinfo_documents = [
  (master_doc, 'IOTileAnalytics', u'IOTile Analytics Documentation',
   author, 'IOTileAnalytics', 'Data science and interactive report generation tools for IOTile.cloud.',
   'Miscellaneous'),
]
