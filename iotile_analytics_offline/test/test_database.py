...
def test_get_data(group, database):
    ...
    data5001 = database.get_datapoints(slug5001)
    grp5001 = group.fetch_stream(slug5001)
    data5002 = database.get_datapoints(slug5002)
    grp5002 = group.fetch_stream(slug5002)

    with pytest.raises(ArgumentError):
        database.get_datapoints('abc')
    ...
    events5001 = database.get_events(slug5001)
    grp5001 = group.fetch_events(slug5001)

    events5002 = database.get_events(slug5002)
    grp5002 = database.get_events(slug5002)
